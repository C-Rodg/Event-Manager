							...
							>
								...
								<div className="form-group">
									...
									<input
										...
										onChange={val =>
											this.updateFormValues("first", val.target.value)}
									/>
								</div>
								<div className="form-group">
									<i className="material-icons form-icon">account_box</i>
									<input
										...
										onChange={val =>
											this.updateFormValues("last", val.target.value)}
									/>
								</div>
								<div className="form-group">
									...
									<input
										...
										onChange={val =>
											this.updateFormValues("company", val.target.value)}
									/>
								</div>
								<div className="form-group">
									...
									<input
										...
										onChange={val =>
											this.updateFormValues("title", val.target.value)}
									/>
								</div>
								<div className="form-group">
									...
									<input
										...
										onChange={val =>
											this.updateFormValues("email", val.target.value)}
									/>
								</div>
								<div className="form-group">
									...
									<input
										...
										onChange={val =>
											this.updateFormValues("phone", val.target.value)}
									/>
								</div>
